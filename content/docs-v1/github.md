...
{{< q-class "box warning" >}}
- To view a preview of a Quire project cloned from GitHub, you’ll need to first run the `npm install` command in your command-line shell. Then run `quire preview` and navigate to [http://localhost:1313/](http://localhost:1313/).
{{< /q-class >}}
