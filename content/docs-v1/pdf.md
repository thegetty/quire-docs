...
- Advanced users: PrinceXML supports images with an Adobe RGB (1998) color profile, which may be preferred for digital printing. Otherwise, both tools support images with standard sRGB color profiles, ensuring color fidelity on screens across Quire's PDF, EPUB, and HTML outputs.
