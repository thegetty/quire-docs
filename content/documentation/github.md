...
- Github makes working with collaborators easy. Each of you can work in different versions of the project, review and comment on one another's work, and incorporate any approved changes into the master project.
...
One of the main advantages of using GitHub is that it's an excellent tool for managing projects with multiple collaborators. Once the project is on GitHub and cloned by you and your colleagues, you can all make changes and commits to the same project. There are two basic ways this can happen:

- You can [fork](https://docs.github.com/en/desktop/contributing-and-collaborating-using-github-desktop/cloning-and-forking-repositories-from-github-desktop#forking-a-repository) the repository, make changes to it, and then submit a [pull request](https://docs.github.com/en/github/collaborating-with-issues-and-pull-requests/proposing-changes-to-your-work-with-pull-requests) for your colleagues to review. Once the request has been approved, you can [merge](https://docs.github.com/en/github/collaborating-with-issues-and-pull-requests/merging-a-pull-request#about-pull-request-merges) changes into the master version of your project. This creates a system of checks and balances so no one can do any irreversible damage to the project.
- You can [be added as a collaborator](https://docs.github.com/en/github/setting-up-and-managing-your-github-user-account/inviting-collaborators-to-a-personal-repository) on the repository. Any collaborators will be able to work directly in the project. (Please note, if your project is hosted in a [GitHub Organization account](https://docs.github.com/en/github/setting-up-and-managing-organizations-and-teams/managing-access-to-your-organizations-repositories) rather than a personal account, there is a slightly different process for adding collaborators.)

### Tips for Collaborating:

Clear communication is vital when collaborating in GitHub. If multiple people are working on a project and all making changes to the same files, there’s a good chance you will run into conflicts. While git is specifically designed to deal with these sorts of issues, it's important to avoid working on the same sections at the same time.

A good way to manage users' changes and avoid conflicts when a project has multiple collaborators is by using [branches](https://docs.github.com/en/github/collaborating-with-issues-and-pull-requests/about-branches#working-with-branches). Branches are essentially parallel versions of a project. Users can make changes on their branch before submitting a pull request to have their changes merged into the master. This allows you to review changes and identify possible conflicts before they are incorporated into your project.
...
At this point, your changes have been saved locally (i.e. only on your computer), but GitHub doesn’t know anything about them. For that, you need to [commit](https://docs.github.com/en/github/getting-started-with-github/github-glossary#commit) the changes to the git record in your project, and then [push](https://docs.github.com/en/github/getting-started-with-github/github-glossary#push) those commits up to GitHub.
...
When naming commits, think of them as meaningful bundles that you could undo at a later date without effecting other areas of your project. Rather than committing all the random changes you made to a single file or everything you did before lunch that day, commit changes that make sense together.
...
Even after saving changes in your text editor and committing them in GitHub Desktop, GitHub still doesn’t know about them. For that, you need to push your commits to GitHub. Use the "Push origin" link in the upper-right corner. Pushing can include one or many commits, and you can push as often as you’d like, but it’s typically good to do it at least a couple of times a day when actively working on a project.
