...
// Randomize display of homepage banner image
window.onload = loadImage;

var images = new Array("/img/illustrations/illustration-multiformat--keepitmoving.png","/img/illustrations/illustration-multiformat--ambers.png");

function loadImage() {
   var randomNumber = Math.floor(Math.random() * images.length);
   document.getElementById("homepage-banner-image").src = images[randomNumber];
}
